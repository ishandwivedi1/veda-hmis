...
echo 'Applying: show investigation findings to the doctor in Diagnosis & Plan...'

mkdir -p 'app/(main)/investigation' 'app/(main)/consultation/[id]'
...
echo '  git add "app/(main)/investigation/investigation-types.js" "app/(main)/consultation/[id]/consultation-form.js"'
echo '  git commit -m "Show investigation findings to doctor in Consultation Diagnosis and Plan"'
echo '  git push'
