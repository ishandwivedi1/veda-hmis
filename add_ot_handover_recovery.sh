...
echo 'Applying: Hand Over to Recovery as a prominent concluding action...'
...
echo '  git commit -m "Add Hand Over to Recovery as concluding action at end of Intraoperative Management tab"'
echo '  git push'
