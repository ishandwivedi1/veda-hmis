...
export async function getMedicalFitnessHistory() {
  ...
  const { data, error } = await supabase
    ...
    .select('*, visits(id, visit_number, patients(first_name, salutation, last_name, uhid, age)), surgical_cases(procedure_name, eye, priority)')
...
export async function getMedicalFitnessQueue() {
  ...
  const { data, error } = await supabase
    .from('medical_fitness_referrals')
    .select('*, visits(id, visit_number, visit_type, patients(first_name, salutation, last_name, uhid, age)), surgical_cases(procedure_name, eye, priority)')
