...
PLACEHOLDER_REFERENCE.opd_case_sheet = [
  ...
  '{{#if hasMultipleProcedures}}...{{/if}}', 'surgeryProcedureList (loop: name, eye -- every procedure in the surgery, primary + additional)',
