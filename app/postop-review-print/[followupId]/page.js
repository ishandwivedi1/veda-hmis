import { renderPostOpReviewHtml } from '@/app/print-templates/actions';
import PrintButton from './print-button';

export default async function PostOpReviewPrintPage({ params }) {
  const { followupId } = await params;
  const result = await renderPostOpReviewHtml(followupId);
  ...
  return (
    <div>
      ...
      {/* eslint-disable-next-line react/no-danger -- renderPostOpReviewHtml
