...
const DEFAULT_TEMPLATES = {
  ...
  opd_case_sheet: "<style>\n  @media print {\n    @page { size: A4; margin: {{#if hide_header}}{{header_space_cm}}cm{{else}}8mm{{/if}} 10mm 8mm 10mm; }\n  }\n</style>\n<div style=\"max-width: 800px; margin: 0 auto; padding: 10px 16px; font-family: Arial, Helvetica, sans-serif; color: #000; font-size: 11px; line-height: 1.45;\">\n\n  {{#unless hide_header}}\n  <!-- HEADER -->\n  <table style=\"width: 100%; border-collapse: collapse; margin-bottom: 3px;\">\n    <tr>\n      <td style=\"width: 100px; vertical-align: top;\">{{{logo_html}}}</td>\n      <td style=\"vertical-align: top;\">\n        <div style=\"font-size: 16px; font-weight: 800; letter-spacing: .3px; text-decoration: underline;\">{{hospital_name}}</div>\n        <div style=\"font-size: 9.5px; font-weight: 700; margin-top: 3px;\">{{hospital_unit_line}}</div>\n        <div style=\"font-size: 9px; font-weight: 700;\">REGN NO : {{hospital_regn_no}}</div>\n      </td>\n      <td style=\"text-align: right; vertical-align: top; font-size: 9.5px; line-height: 1.6;\">\n        {{hospital_address_line1}}<br/>\n        {{hospital_address_line2}}<br/>\n        {{hospital_city_state_pin}}<br/>\n        Tel: {{hospital_phone}}\n      </td>\n    </tr>\n  </table>\n  {{/unless}}\n  {{#if hide_header}}<!-- Blank space for the pad's pre-printed header is reserved by the @page top margin above, so it repeats on every printed page, not just the first. -->{{/if}}\n\n  <div style=\"text-align: center; font-size: 15px; font-weight: 800; letter-spacing: .5px; border-top: 1.5px solid #333; border-bottom: 1.5px solid #333; padding: 7px 0; margin: 6px 0 10px;\">\n    OPD CASE SHEET\n  </div>\n\n  <!-- PATIENT / VISIT INFO -->\n  <table style=\"width: 100%; border: 1.5px solid #333; border-collapse: collapse; margin-bottom: 12px;\">\n    <tr>\n      <td style=\"width: 50%; padding: 9px 14px; vertical-align: top; font-size: 11px; line-height: 1.6; border-right: 1px solid #ccc;\">\n        <table style=\"width: 100%; font-size: 11px;\">\n          <tr><td style=\"width: 120px; color: #222;\">PATIENT ID</td><td>: <strong>{{patient_id}}</strong></td></tr>\n          <tr><td style=\"color: #222;\">NAME</td><td>: <strong>{{patient_name}}</strong></td></tr>\n          <tr><td style=\"color: #222;\">AGE/GENDER</td><td>: <strong>{{patient_age}} / {{patient_gender}}</strong></td></tr>\n          <tr><td style=\"color: #222;\">MOBILE</td><td>: <strong>{{patient_mobile}}</strong></td></tr>\n        </table>\n      </td>\n      <td style=\"width: 50%; padding: 9px 14px; vertical-align: top; font-size: 11px; line-height: 1.6;\">\n        <table style=\"width: 100%; font-size: 11px;\">\n          <tr><td style=\"width: 120px; color: #222;\">VISIT DATE</td><td>: <strong>{{visit_date}}</strong></td></tr>\n          <tr><td style=\"color: #222;\">VISIT TYPE</td><td>: <strong>{{visit_type}}</strong></td></tr>\n          <tr><td style=\"color: #222;\">DOCTOR</td><td>: <strong>{{doctor_name}}</strong></td></tr>\n          <tr><td style=\"color: #222;\">DOCTOR REGN NO</td><td>: <strong>{{doctor_regn_no}}</strong></td></tr>\n        </table>\n      </td>\n    </tr>\n  </table>\n\n  <!-- CHIEF COMPLAINT -->\n  {{#if chief_complaint}}\n  <div style=\"margin-bottom: 6px;\">\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">Chief Complaint</div>\n    <div style=\"font-size: 11px;\">{{chief_complaint}}{{#if hx_duration}} -- {{hx_duration}}{{/if}}{{#if hx_laterality}} ({{hx_laterality}}){{/if}}</div>\n    {{#if hx_hopi}}<div style=\"font-size: 10.5px; color: #333; margin-top: 4px;\">{{hx_hopi}}</div>{{/if}}\n  </div>\n  {{/if}}\n\n  <!-- STRUCTURED HISTORY -->\n  {{#if hasHistory}}\n  <div style=\"margin-bottom: 6px;\">\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">History</div>\n    <table style=\"width: 100%; font-size: 10.5px; border-collapse: collapse;\">\n      {{#each historyLines}}\n      <tr>\n        <td style=\"padding: 4px 0; width: 140px; color: #222; vertical-align: top;\">{{label}}</td>\n        <td style=\"padding: 4px 0;\">{{text}}</td>\n      </tr>\n      {{/each}}\n    </table>\n  </div>\n  {{/if}}\n\n  <!-- VISION / IOP -->\n  {{#if hasVision}}\n  <div style=\"margin-bottom: 6px;\">\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">Vision &amp; Intraocular Pressure</div>\n    <div style=\"display: flex; gap: 10px;\">\n      {{#if hasVaSection}}\n      <div style=\"{{#if hasIop}}flex: 1; min-width: 0;{{else}}width: 100%;{{/if}}\">\n        <table style=\"width: 100%; border-collapse: collapse; font-size: 10.5px;\">\n          <tr style=\"background: #e9edf2;\">\n            <th style=\"border: 1px solid #999; padding: 6px 5px; text-align: left; width: 42%;\"></th>\n            <th style=\"border: 1px solid #999; padding: 6px 5px; width: 29%;\">Right Eye (RE)</th>\n            <th style=\"border: 1px solid #999; padding: 6px 5px; width: 29%;\">Left Eye (LE)</th>\n          </tr>\n          {{#if hasViUnaided}}\n          <tr>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; font-weight: 600;\">Unaided</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{re_vision_unaided}}</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{le_vision_unaided}}</td>\n          </tr>\n          {{/if}}\n          {{#if hasViGlasses}}\n          <tr>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; font-weight: 600;\">With Glasses</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{re_vision_glasses}}</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{le_vision_glasses}}</td>\n          </tr>\n          {{/if}}\n          {{#if hasViPh}}\n          <tr>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; font-weight: 600;\">Pinhole</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{re_vision_ph}}</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{le_vision_ph}}</td>\n          </tr>\n          {{/if}}\n          {{#if hasViNear}}\n          <tr>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; font-weight: 600;\">Near</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{re_vision_near}}</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{le_vision_near}}</td>\n          </tr>\n          {{/if}}\n        </table>\n      </div>\n      {{/if}}\n      {{#if hasIop}}\n      <div style=\"{{#if hasVaSection}}flex: 1; min-width: 0; border-left: 1px dashed #ccc; padding-left: 10px;{{else}}width: 100%;{{/if}}\">\n        <table style=\"width: 100%; border-collapse: collapse; font-size: 10.5px;\">\n          <tr style=\"background: #e9edf2;\">\n            <th style=\"border: 1px solid #999; padding: 6px 5px; text-align: left; width: 42%;\"></th>\n            <th style=\"border: 1px solid #999; padding: 6px 5px; width: 29%;\">Right (OD)</th>\n            <th style=\"border: 1px solid #999; padding: 6px 5px; width: 29%;\">Left (OS)</th>\n          </tr>\n          <tr>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; font-weight: 600;\">IOP (mmHg){{#if iop_method}}<br/><span style=\"font-size: 9px; font-weight: 400; color: #444;\">({{iop_method}})</span>{{/if}}</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{re_iop}}</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{le_iop}}</td>\n          </tr>\n        </table>\n      </div>\n      {{/if}}\n    </div>\n  </div>\n  {{/if}}\n\n  {{#if hasDistRx}}\n  <div style=\"margin-bottom: 6px;\">\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">Refraction (Final Rx)</div>\n    <table style=\"width: 100%; border-collapse: collapse; font-size: 10px;\">\n      <tr style=\"background: #e9edf2;\">\n        <th style=\"border: 1px solid #999; padding: 6px 5px; text-align: left; width: 90px;\" rowspan=\"2\"></th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px;\" colspan=\"5\">Right Eye (RE)</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; border-left: 2px solid #999;\" colspan=\"5\">Left Eye (LE)</th>\n      </tr>\n      <tr style=\"background: #e9edf2;\">\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">SPH</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">CYL</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">AXIS</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">PRISM</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">VISION</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%; border-left: 2px solid #999;\">SPH</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">CYL</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">AXIS</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">PRISM</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">VISION</th>\n      </tr>\n      <tr>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; font-weight: 700;\">Dist.</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center; font-weight: 600;\">{{dist_re_sph}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{dist_re_cyl}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{dist_re_axis}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{dist_re_prism}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{dist_re_va}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center; font-weight: 600; border-left: 2px solid #999;\">{{dist_le_sph}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{dist_le_cyl}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{dist_le_axis}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{dist_le_prism}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{dist_le_va}}</td>\n      </tr>\n      <tr>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; font-weight: 700;\">NEAR ADD</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center; font-weight: 600;\" colspan=\"4\">{{near_add_re}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{#if hasNearRx}}{{near_re_va}}{{else}}--{{/if}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center; font-weight: 600; border-left: 2px solid #999;\" colspan=\"4\">{{near_add_le}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{#if hasNearRx}}{{near_le_va}}{{else}}--{{/if}}</td>\n      </tr>\n    </table>\n  </div>\n  {{else}}\n  {{#if hasNearRx}}\n  <div style=\"margin-bottom: 6px;\">\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">Refraction (Final Rx)</div>\n    <table style=\"width: 100%; border-collapse: collapse; font-size: 10px;\">\n      <tr style=\"background: #e9edf2;\">\n        <th style=\"border: 1px solid #999; padding: 6px 5px; text-align: left; width: 90px;\" rowspan=\"2\"></th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px;\" colspan=\"5\">Right Eye (RE)</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; border-left: 2px solid #999;\" colspan=\"5\">Left Eye (LE)</th>\n      </tr>\n      <tr style=\"background: #e9edf2;\">\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">SPH</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">CYL</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">AXIS</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">PRISM</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">VISION</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%; border-left: 2px solid #999;\">SPH</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">CYL</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">AXIS</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">PRISM</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px; width: 8%;\">VISION</th>\n      </tr>\n      <tr>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; font-weight: 700;\">NEAR ADD</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center; font-weight: 600;\" colspan=\"4\">{{near_add_re}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{near_re_va}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center; font-weight: 600; border-left: 2px solid #999;\" colspan=\"4\">{{near_add_le}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{near_le_va}}</td>\n      </tr>\n    </table>\n  </div>\n  {{/if}}\n  {{/if}}\n\n  {{#if hasGlassesSection}}\n  <table style=\"width: 100%; margin-bottom: 6px; font-size: 10.5px;\">\n    {{#if glasses_prescribed}}\n    <tr>\n      <td style=\"padding: 4px 0; color: #222; width: 140px;\">GLASSES PRESCRIBED</td>\n      <td style=\"padding: 4px 0; font-weight: 700;\">: YES</td>\n    </tr>\n    {{/if}}\n    {{#if hasGlassesType}}\n    <tr>\n      <td style=\"padding: 4px 0; color: #222; width: 140px;\">TYPE OF GLASS</td>\n      <td style=\"padding: 4px 0; font-weight: 700;\">: {{glasses_type}}</td>\n    </tr>\n    {{/if}}\n    {{#if hasGlassesRemarks}}\n    <tr>\n      <td style=\"padding: 4px 0; color: #222; width: 140px; vertical-align: top;\">REMARKS</td>\n      <td style=\"padding: 4px 0;\">: {{glasses_remarks}}</td>\n    </tr>\n    {{/if}}\n  </table>\n  {{/if}}\n\n  <!-- ADDITIONAL PRE-OP TESTS -->\n  {{#if hasAdditionalTests}}\n  <div style=\"margin-bottom: 6px;\">\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">Additional Tests</div>\n    <table style=\"width: 100%; font-size: 10.5px; border-collapse: collapse;\">\n      {{#each additionalTests}}\n      <tr>\n        <td style=\"padding: 4px 0; width: 140px; color: #222;\">{{label}}</td>\n        <td style=\"padding: 4px 0;\">{{value}}</td>\n      </tr>\n      {{/each}}\n    </table>\n  </div>\n  {{/if}}\n\n  <!-- OPTOMETRY OBSERVATIONS -->\n  {{#if hasOptObservations}}\n  <div style=\"margin-bottom: 6px;\">\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">Optometry Observations</div>\n    <div style=\"font-size: 11px;\">{{optObservations}}</div>\n  </div>\n  {{/if}}\n\n  <!-- EXAMINATION -->\n  {{#if hasExamination}}\n  <div style=\"margin-bottom: 6px;\">\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">Examination Findings</div>\n\n    {{#each examPairs}}\n    <div style=\"display: flex; gap: 10px;\">\n      <div style=\"{{#if right}}flex: 1; min-width: 0;{{else}}width: 100%;{{/if}}\">\n        <div style=\"font-size: 10.5px; font-weight: 700; text-transform: uppercase; letter-spacing: .4px; color: #35507a; margin: 10px 0 5px; padding: 3px 0 3px 9px; border-left: 3px solid #7f9cc4;\">{{left.label}}</div>\n        <table style=\"width: 100%; border-collapse: collapse; font-size: 10px; margin-bottom: 8px;\">\n          <tr style=\"background: #e9edf2;\">\n            <th style=\"border: 1px solid #999; padding: 6px 5px; text-align: left; width: 42%;\"></th>\n            <th style=\"border: 1px solid #999; padding: 6px 5px; width: 29%;\">{{left.reHeader}}</th>\n            <th style=\"border: 1px solid #999; padding: 6px 5px; width: 29%;\">{{left.leHeader}}</th>\n          </tr>\n          {{#each left.rows}}\n          <tr>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; font-weight: 600;\">{{structure}}</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{re}}</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{le}}</td>\n          </tr>\n          {{/each}}\n        </table>\n      </div>\n      {{#if right}}\n      <div style=\"flex: 1; min-width: 0; border-left: 1px dashed #ccc; padding-left: 10px;\">\n        <div style=\"font-size: 10.5px; font-weight: 700; text-transform: uppercase; letter-spacing: .4px; color: #35507a; margin: 10px 0 5px; padding: 3px 0 3px 9px; border-left: 3px solid #7f9cc4;\">{{right.label}}</div>\n        <table style=\"width: 100%; border-collapse: collapse; font-size: 10px; margin-bottom: 8px;\">\n          <tr style=\"background: #e9edf2;\">\n            <th style=\"border: 1px solid #999; padding: 6px 5px; text-align: left; width: 42%;\"></th>\n            <th style=\"border: 1px solid #999; padding: 6px 5px; width: 29%;\">{{right.reHeader}}</th>\n            <th style=\"border: 1px solid #999; padding: 6px 5px; width: 29%;\">{{right.leHeader}}</th>\n          </tr>\n          {{#each right.rows}}\n          <tr>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; font-weight: 600;\">{{structure}}</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{re}}</td>\n            <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{le}}</td>\n          </tr>\n          {{/each}}\n        </table>\n      </div>\n      {{/if}}\n    </div>\n    {{/each}}\n\n    {{#unless hasExternal}}{{#unless hasAnterior}}{{#unless hasPosterior}}{{#unless hasApplanation}}{{#unless hasGonioscopy}}\n    <div style=\"font-size: 10.5px; color: #444; margin-bottom: 4px;\">No examination findings recorded.</div>\n    {{/unless}}{{/unless}}{{/unless}}{{/unless}}{{/unless}}\n\n    {{#if hasExamExtra}}\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">Clinical Remarks</div>\n    <table style=\"width: 100%; font-size: 10.5px; border-collapse: collapse;\">\n      {{#each examExtra}}\n      <tr>\n        <td style=\"padding: 4px 0; width: 140px; color: #222;\">{{label}}</td>\n        <td style=\"padding: 4px 0;\">{{value}}</td>\n      </tr>\n      {{/each}}\n    </table>\n    {{/if}}\n  </div>\n  {{/if}}\n\n  <!-- DIAGNOSIS -->\n  {{#if hasDiagnoses}}\n  <div style=\"margin-bottom: 6px;\">\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">Diagnosis</div>\n    <ul style=\"margin: 0; padding-left: 18px; font-size: 11px; line-height: 1.6;\">\n      {{#each diagnoses}}\n      <li>{{name}} -- {{eye}}{{#if notes}} ({{notes}}){{/if}}</li>\n      {{/each}}\n    </ul>\n  </div>\n  {{/if}}\n\n  <!-- SURGERY ADVISED -->\n  {{#if hasSurgery}}\n  <div style=\"margin-bottom: 6px;\">\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">Surgery Advised</div>\n    <div style=\"font-size: 11px;\">{{surgery_procedure_name}} -- {{surgery_eye}}</div>\n  </div>\n  {{/if}}\n\n  <!-- PRESCRIPTION -->\n  {{#if hasPrescriptions}}\n  <div style=\"margin-bottom: 6px;\">\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">Prescription (Rx)</div>\n    <table style=\"width: 100%; border-collapse: collapse; font-size: 10.5px;\">\n      <tr style=\"background: #e9edf2;\">\n        <th style=\"border: 1px solid #999; padding: 6px 5px; text-align: left;\">Medicine</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px;\">Eye</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px;\">Dosage</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px;\">Frequency</th>\n        <th style=\"border: 1px solid #999; padding: 6px 5px;\">Duration</th>\n      </tr>\n      {{#each prescriptions}}\n      <tr>\n        <td style=\"border: 1px solid #999; padding: 6px 5px;\">{{drug}}{{#if isTaper}} <span style=\"font-size: 9px; font-weight: 700; color: #7c3aed; text-transform: uppercase;\">(Taper)</span>{{/if}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{eye}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{dosage}}</td>\n        {{#if isTaper}}\n        <td colspan=\"2\" style=\"border: 1px solid #999; padding: 6px 5px; text-align: center; font-size: 9.5px;\">{{frequency}}</td>\n        {{else}}\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{frequency}}</td>\n        <td style=\"border: 1px solid #999; padding: 6px 5px; text-align: center;\">{{duration}}</td>\n        {{/if}}\n      </tr>\n      {{/each}}\n    </table>\n  </div>\n  {{/if}}\n\n  <!-- ADVICE -->\n  {{#if advice}}\n  <div style=\"margin-bottom: 6px;\">\n    <div style=\"font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: .5px; color: #1a3a5c; margin: 18px 0 8px; padding-bottom: 5px; border-bottom: 1.5px solid #c7d2e0;\">Advice</div>\n    <div style=\"font-size: 11px; white-space: pre-wrap; line-height: 1.5;\">{{advice}}</div>\n  </div>\n  {{/if}}\n\n  <!-- FOLLOW UP -->\n  {{#if followup_text}}\n  <div style=\"background: #e7eff8; border: 1px solid #1e4e8c; border-radius: 8px; padding: 8px 12px; font-size: 11px; color: #123a66; margin-bottom: 10px; margin-top: 4px;\">\n    <strong>Follow-up:</strong> {{followup_text}}\n  </div>\n  {{/if}}\n\n  <table style=\"width: 100%; margin-top: 26px;\">\n    <tr>\n      <td style=\"font-size: 10.5px;\">&nbsp;</td>\n      <td style=\"text-align: right; font-size: 10.5px;\">\n        <div style=\"height: 46px;\">&nbsp;</div>\n        <div style=\"border-top: 1px solid #333; width: 210px; margin-left: auto; padding-top: 5px; font-weight: 700;\">{{doctor_name}}</div>\n        <div style=\"font-size: 9.5px; color: #444;\">Reg No: {{doctor_regn_no}}</div>\n      </td>\n    </tr>\n  </table>\n\n  <div style=\"text-align: center; margin-top: 10px; font-size: 9.5px; color: #888;\">\n    For any Queries please contact us at {{hospital_phone}} or Email us at {{hospital_email}}\n  </div>\n</div>\n",
