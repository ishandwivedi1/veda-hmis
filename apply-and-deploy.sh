...
echo "== Veda HMIS: Biometry lock-mode + doctor-only edit, direct View Report link, duplicate-order guard, Biometry queue fix, referral print simplification ==" 
...
git commit -m "Biometry: lock finalized report by default, doctor-only edit unlock, direct View Report link from Surgical Journey; prevent duplicate investigation orders; fix Biometry queue routing; simplify external investigation referral print"
