...
echo "Applying: OPD case sheet print readability (bold spaced headings), remove Patient Decision from surgery print, fix pre-printed header space on page 2+"
