...
echo 'Applying: Follow-up Consultation Template (extends the existing consultation engine)...'

mkdir -p 'app/(main)/consultation/[id]'
...
echo '  git add "app/(main)/consultation/actions.js" "app/(main)/consultation/[id]/consultation-form.js" "app/(main)/consultation/[id]/follow-up-panel.js"'
echo '  git commit -m "Add Follow-up Consultation Template: timeline, patient snapshot, previous visit summary, carry-forward diagnosis, visit outcome"'
echo '  git push'
