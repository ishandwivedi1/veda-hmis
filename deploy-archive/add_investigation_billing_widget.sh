bash add_investigation_billing_widget.sh#!/bin/bash
set -e

echo 'Applying: Prescribed Investigations billing widget + prefill...'
...
cat > 'app/(main)/front-office-dashboard/investigations-billing-widget.js' << 'WIDGET_EOF'
'use client';
...
echo '  git add "app/(main)/investigation/actions.js" "app/(main)/billing/actions.js" "app/(main)/billing/new/new-invoice-tab.js" "app/(main)/front-office-dashboard/page.js" "app/(main)/front-office-dashboard/investigations-billing-widget.js"'
echo '  git commit -m "Add Prescribed Investigations billing widget on Front Office dashboard"'
echo '  git push'
