...
echo 'Applying: doctor opens the real technician entry screen, read-only...'

mkdir -p 'app/(main)/investigation/[id]' 'app/(main)/consultation/[id]'
...
cat > 'app/(main)/investigation/[id]/page.js' << 'INV_ID_PAGE_EOF'
...
echo '  git add "app/(main)/investigation/[id]/workspace.js" "app/(main)/investigation/[id]/page.js" "app/(main)/consultation/[id]/consultation-form.js"'
echo '  git commit -m "Doctor views investigation findings via read-only technician entry screen"'
echo '  git push'
