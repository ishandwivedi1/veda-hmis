...
echo 'Applying: Medical Fitness tabs (Queue / Workspace / History) + doctor name+timestamp on decision...'

mkdir -p 'app/(main)/medical-fitness/[id]' 'app/(main)/medical-fitness/history'
...
cat > 'app/(main)/medical-fitness/medical-fitness-tabs.js' << 'MF_TABS_EOF'
'use client';
...
cat > 'app/(main)/medical-fitness/history/page.js' << 'MF_HISTORY_EOF'
'use client';
...
echo '  git commit -m "Medical Fitness: Queue/Workspace/History tabs; doctor name + timestamp on decision"'
echo '  git push'
