...
echo 'Applying: Check In / Back to Queue buttons; gate Intraoperative Management tab on check-in...'
...
echo '  git commit -m "Add Check In / Back to Queue buttons; gate Intraoperative Management tab on check-in"'
echo '  git push'
