...
echo 'Applying: Prescribed Medicines billing widget + prefill...'

mkdir -p 'app/(main)/pharmacy' 'app/(main)/billing/new' 'app/(main)/front-office-dashboard'

cat > 'app/(main)/pharmacy/actions.js' << 'PHARM_ACTIONS_EOF'
'use server';
...
cat > 'app/(main)/pharmacy/page.js' << 'PHARM_PAGE_EOF'
'use client';
...
cat > 'app/(main)/front-office-dashboard/pharmacy-billing-widget.js' << 'PHARM_WIDGET_EOF'
'use client';
...
echo '  git add "app/(main)/pharmacy/actions.js" "app/(main)/pharmacy/page.js" "app/(main)/billing/actions.js" "app/(main)/billing/new/new-invoice-tab.js" "app/(main)/billing/new/page.js" "app/(main)/front-office-dashboard/page.js" "app/(main)/front-office-dashboard/pharmacy-billing-widget.js"'
echo '  git commit -m "Add Prescribed Medicines billing widget on Front Office dashboard"'
echo '  git push'
