...
echo "== Consolidating consultation sidebars =="
echo "   Encounter Status / Outstanding Tasks / Audit Log moved from the"
echo "   right column into the left sidebar, below Previous Investigations."
echo "   Main content now has the full remaining width -- no right column."

echo "-- Writing app/(main)/consultation/[id]/follow-up-panel.js --"
mkdir -p "$(dirname "app/(main)/consultation/[id]/follow-up-panel.js")"
cat > "app/(main)/consultation/[id]/follow-up-panel.js" << 'JSEOF_26014302'
'use client';
...
cat > "app/(main)/consultation/[id]/consultation-form.js" << 'JSEOF_27550234'
'use client';
