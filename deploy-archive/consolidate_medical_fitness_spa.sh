...
echo 'Applying: consolidate Medical Fitness into a single SPA page (Counselling-style)...'

mkdir -p 'app/(main)/medical-fitness'

# Remove the old route-based files -- everything now lives in one page.js
rm -rf 'app/(main)/medical-fitness/[id]' 'app/(main)/medical-fitness/history' 'app/(main)/medical-fitness/medical-fitness-tabs.js'
...
echo '  git add -A "app/(main)/medical-fitness"'
echo '  git commit -m "Consolidate Medical Fitness into single SPA page, matching Counselling architecture"'
echo '  git push'
