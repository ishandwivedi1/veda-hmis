#!/bin/bash
set -e
echo "Applying: real Billing Dashboard (WS-086) + moving pending-billing widgets from Front Office"

rm -f "app/(main)/front-office-dashboard/investigations-billing-widget.js"
rm -f "app/(main)/front-office-dashboard/procedures-billing-widget.js"
rm -f "app/(main)/front-office-dashboard/pharmacy-billing-widget.js"
rm -f "app/(main)/front-office-dashboard/biometry-billing-widget.js"
rm -f "app/(main)/front-office-dashboard/package-billing-widget.js"

cat > "app/(main)/billing/actions.js" << 'PYEOF_3388427266056361329'
'use server';
...
PYEOF_3388427266056361329

cat > "app/(main)/billing/page.js" << 'PYEOF_1264309893464015030'
...
PYEOF_1264309893464015030

cat > "app/(main)/billing/recent-invoices-table.js" << 'PYEOF_5460755010680571624'
'use client';
...
PYEOF_5460755010680571624

cat > "app/(main)/billing/investigations-billing-widget.js" << 'PYEOF_8405078624323455492'
'use client';
...
PYEOF_8405078624323455492

cat > "app/(main)/billing/procedures-billing-widget.js" << 'PYEOF_5361770982912953647'
'use client';
...
PYEOF_5361770982912953647

cat > "app/(main)/billing/pharmacy-billing-widget.js" << 'PYEOF_2349957582380655454'
'use client';
...
PYEOF_2349957582380655454

cat > "app/(main)/billing/biometry-billing-widget.js" << 'PYEOF_6909453175922999278'
'use client';
...
PYEOF_6909453175922999278

cat > "app/(main)/billing/package-billing-widget.js" << 'PYEOF_1122401571745804379'
'use client';
...
PYEOF_1122401571745804379

cat > "app/(main)/front-office-dashboard/page.js" << 'PYEOF_1023572416561372680'
import Link from 'next/link';
import { createClient } from '@/lib/supabase-server';
