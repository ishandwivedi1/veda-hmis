#!/bin/bash
set -e
echo "Applying: print option on Recent Invoices + redirect to Billing Dashboard after collecting"

cat > "app/(main)/billing/recent-invoices-table.js" << 'PYEOF_5404499866296031563'
'use client';
...
PYEOF_5404499866296031563

cat > "app/(main)/payments/collect/collect-payment-tab.js" << 'PYEOF_1442436030688443040'
'use client';
