#!/bin/bash
set -e
echo "Deploying: Glasses Prescription print + OPD Case Sheet refraction bug fix"
...
const SAMPLE_CASE_SHEET_RAW = {
  ...
  assessment: {
    ...
    ref_final_re_dist_sph: '-2.00', ref_final_re_dist_cyl: '-0.50', ref_final_re_dist_axis: '90',
    ref_final_le_dist_sph: '-1.50', ref_final_le_dist_cyl: '-0.25', ref_final_le_dist_axis: '85',
...
function buildOpdCaseSheetContext(settings, { patient, encounter, visit, doctor, assessment, iopReadings, examination, diagnoses, prescriptions, followup }) {
  ...
  const hasRefraction = !!(assessment?.ref_final_re_dist_sph || assessment?.ref_final_le_dist_sph);
  ...
  return {
    ...
    hasRefraction,
    re_refraction: refractionStr(assessment?.ref_final_re_dist_sph, assessment?.ref_final_re_dist_cyl, assessment?.ref_final_re_dist_axis),
    le_refraction: refractionStr(assessment?.ref_final_le_dist_sph, assessment?.ref_final_le_dist_cyl, assessment?.ref_final_le_dist_axis),
...
mkdir -p "$(dirname "app/glasses-prescription-print/[assessmentId]/page.js")"
cat > "app/glasses-prescription-print/[assessmentId]/page.js" << 'VEDA_EOF_MARKER'
...
echo "  app/glasses-prescription-print/[assessmentId]/page.js"