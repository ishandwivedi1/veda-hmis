#!/bin/bash
set -e
echo "Applying: fix login requiring a second click (hard navigation instead of router.push)"

cat > "app/login/page.js" << 'PYEOF_5943879345934536070'
'use client';
...
PYEOF_5943879345934536070

cat > "app/reset-password/page.js" << 'PYEOF_8667302837653679625'
'use client';
