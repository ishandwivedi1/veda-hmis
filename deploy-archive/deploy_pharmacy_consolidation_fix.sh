#!/bin/bash
set -e
echo "Applying: real fix for pharmacy consolidation (custom line-item RPC + manual-entry path)"

cat > "app/(main)/billing/actions.js" << 'PYEOF_1039973979246863098'
'use server';
...
PYEOF_1039973979246863098

cat > "app/(main)/billing/new/new-invoice-tab.js" << 'PYEOF_7265916926994386136'
'use client';
