...
echo "== Combined fix: OT-merge restore + Mark Patient Reported =="
echo "   1. Restores master-data/counselling files + AppShell nav"
echo "      (safe to re-run even if you already applied the previous fix)"
echo "   2. Adds working Mark Patient Reported to the OT dashboard + workspace"

echo "-- Writing app/(main)/master-data/actions.js --"
mkdir -p "$(dirname "app/(main)/master-data/actions.js")"
cat > "app/(main)/master-data/actions.js" << 'JSEOF_55018239'
'use server';
...
cat > "app/(main)/counselling/actions.js" << 'JSEOF_9106276'
'use server';
...
cat > "app/(main)/counselling/page.js" << 'JSEOF_36812603'
'use client';
...
cat > "app/components/AppShell.js" << 'JSEOF_37361777'
'use client';
...
echo "-- Writing app/(main)/ot-intraop/actions.js --"
mkdir -p "$(dirname "app/(main)/ot-intraop/actions.js")"
cat > "app/(main)/ot-intraop/actions.js" << 'JSEOF_32587132'
'use server';
...
echo "-- Writing app/(main)/ot-intraop/page.js --"
mkdir -p "$(dirname "app/(main)/ot-intraop/page.js")"
cat > "app/(main)/ot-intraop/page.js" << 'JSEOF_68795351'
'use client';
...
echo "-- Writing app/(main)/ot-intraop/workspace.js --"
mkdir -p "$(dirname "app/(main)/ot-intraop/workspace.js")"
cat > "app/(main)/ot-intraop/workspace.js" << 'JSEOF_76785624'
'use client';
