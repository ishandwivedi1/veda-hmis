...
echo "== Three fixes =="
echo "   1. OT Calendar blank in Counselling -- fixed ambiguous DB join"
echo "   2. Added History tab to Counselling (was genuinely missing)"
echo "   3. OT check-in now blocked if approved IOL plan is missing power/manufacturer"

echo "-- Writing app/(main)/counselling/actions.js --"
mkdir -p "$(dirname "app/(main)/counselling/actions.js")"
cat > "app/(main)/counselling/actions.js" << 'JSEOF_76806538'
'use server';
...
cat > "app/(main)/counselling/page.js" << 'JSEOF_74929451'
'use client';
...
cat > "app/(main)/ot-intraop/actions.js" << 'JSEOF_39465549'
'use server';
