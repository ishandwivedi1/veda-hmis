...
echo 'Applying: loosen follow-up detection to any prior encounter, not just completed ones...'
...
echo '  git add "app/(main)/consultation/actions.js" "app/(main)/consultation/[id]/follow-up-panel.js"'
echo '  git commit -m "Fix follow-up detection: trigger on any prior encounter, not just completed ones"'
echo '  git push'
