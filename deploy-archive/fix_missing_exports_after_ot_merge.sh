...
echo "== Restoring functions lost in the previous OT-merge script =="
echo "   (Surgical Consumables master-data CRUD, updateSurgicalCase," 
echo "    and the duplicate-surgical-case guard in markForSurgery)"

echo "-- Writing app/(main)/master-data/actions.js --"
mkdir -p "$(dirname "app/(main)/master-data/actions.js")"
cat > "app/(main)/master-data/actions.js" << 'JSEOF_62800236'
'use server';
...
cat > "app/(main)/counselling/actions.js" << 'JSEOF_74271102'
'use server';
