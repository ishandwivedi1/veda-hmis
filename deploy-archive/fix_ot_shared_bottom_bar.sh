...
echo 'Applying: remove shared bottom bar, move Save Draft/Surgery Complete into Intraoperative Management tab...'
...
echo '  git add "app/(main)/ot-intraop/workspace.js"'
echo '  git commit -m "Remove shared bottom bar; move Save Draft/Surgery Complete into Intraoperative Management tab only"'
echo '  git push'
