...
echo 'Applying: final Recovery button now shows Discharged instead of Go to Post Op...'
...
echo '  git add "app/(main)/ot-recovery/workspace.js"'
echo '  git commit -m "Recovery: final button now shows Discharged confirmation instead of Go to Post Op"'
echo '  git push'
