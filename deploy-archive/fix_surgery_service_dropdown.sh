...
echo 'Applying: fix empty Service dropdown for Surgery department -- add packages to the service catalog...'
...
echo '  git add "app/(main)/billing/actions.js"'
echo '  git commit -m "Fix empty Service dropdown for Surgery department -- packages were never added to the service catalog"'
echo '  git push'
