...
echo 'Applying: widget moved to RHS + New Invoice fresh-state fix...'

mkdir -p 'app/(main)/front-office-dashboard' 'app/(main)/billing/new'
...
echo '  git add "app/(main)/front-office-dashboard/page.js" "app/(main)/front-office-dashboard/investigations-billing-widget.js" "app/(main)/billing/new/page.js"'
echo '  git commit -m "Move investigations widget to RHS; fix New Invoice retaining stale patient/line items"'
echo '  git push'
