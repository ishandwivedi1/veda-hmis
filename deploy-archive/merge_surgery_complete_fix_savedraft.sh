...
echo 'Applying: merge Hand Over to Recovery into Surgery Complete; fix Save Draft...'
...
echo '  git commit -m "Merge Hand Over to Recovery into Surgery Complete; fix Save Draft error handling"'
echo '  git push'
