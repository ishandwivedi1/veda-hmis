...
echo "== Payment Receipt + Advance Receipt templates =="
echo "   Two new editable templates, same header/hospital-settings as"
echo "   the invoice templates: Payment Receipt (for a normal payment,"
echo "   shows which invoice(s) it was applied against) and Advance"
echo "   Receipt (for a fresh advance collection, before it is applied"
echo "   to anything -- includes an amount-in-words line, standard on"
echo "   Indian receipts)."
...
cat > "app/print-templates/actions.js" << 'JSEOF_62774474'
'use server';
...
echo "-- Writing app/receipt-print/[paymentId]/page.js --"
mkdir -p "$(dirname "app/receipt-print/[paymentId]/page.js")"
cat > "app/receipt-print/[paymentId]/page.js" << 'JSEOF_83706360'
import { renderReceiptHtml } from '@/app/print-templates/actions';
...
export default async function ReceiptPrintPage({ params }) {
  ...
  return (
    <div>
      ...
      {/* eslint-disable-next-line react/no-danger -- renderReceiptHtml
...
cat > "app/(main)/print-templates/page.js" << 'JSEOF_54412049'
'use client';
