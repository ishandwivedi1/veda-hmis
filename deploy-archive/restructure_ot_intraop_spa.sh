...
echo 'Applying: restructure Intraoperative Management into Dashboard/Workspace/History SPA...'
...
echo '  git add "app/(main)/ot-intraop/actions.js" "app/(main)/ot-intraop/page.js" "app/(main)/ot-intraop/workspace.js"'
echo '  git commit -m "Restructure Intraoperative Management into Dashboard/Workspace/History, matching Counselling and Medical Fitness"'
echo '  git push'
