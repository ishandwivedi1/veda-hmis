...
echo 'Applying: remove Investigations section from Counselling -- Medical Fitness only after acceptance...'
...
echo '  git commit -m "Simplify Counselling post-acceptance flow to Medical Fitness only"'
echo '  git push'
