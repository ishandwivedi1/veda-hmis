...
echo 'Applying: split OT Intraop workspace into Patient Check-In / Intraoperative Management tabs...'
...
echo '  git commit -m "Split OT Intraop into Patient Check-In and Intraoperative Management tabs"'
echo '  git push'
