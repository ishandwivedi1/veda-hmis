#!/bin/bash
set -e
echo "Applying: Discharge Summary + Investigation Report print templates"

mkdir -p "app/investigation-print/[investigationId]"

cat > "app/print-templates/actions.js" << 'PYEOF_5486492704952791389'
'use server';
...
PYEOF_5486492704952791389

cat > "app/(main)/print-templates/page.js" << 'PYEOF_1742591749578496135'
'use client';
...
PYEOF_1742591749578496135

cat > "app/investigation-print/[investigationId]/page.js" << 'PYEOF_7065425763546238480'
...
PYEOF_7065425763546238480

cat > "app/investigation-print/[investigationId]/print-button.js" << 'PYEOF_1899454373926817901'
'use client';
...
PYEOF_1899454373926817901

cat > "app/discharge-summary-print/[episodeId]/page.js" << 'PYEOF_1818757741028461270'
...
PYEOF_1818757741028461270

cat > "app/(main)/investigation/history/page.js" << 'PYEOF_8254400634683980341'
'use client';
...
PYEOF_8254400634683980341

cat > "app/(main)/investigation/[id]/workspace.js" << 'PYEOF_740243462065514414'
'use client';
