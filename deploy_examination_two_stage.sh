#!/bin/bash
set -e
echo "Applying: two-stage Examination (without/with dilation), Glaucoma moved after Posterior, print updated"

cat > "app/consultation/[id]/examination-tab.js" << 'PYEOF_7101372601632977663'
'use client';
...
PYEOF_7101372601632977663

cat > "app/print-templates/actions.js" << 'PYEOF_6667821001355737494'
'use server';
...
PYEOF_6667821001355737494

cat > "app/(main)/print-templates/page.js" << 'PYEOF_6497215697154773186'
'use client';
