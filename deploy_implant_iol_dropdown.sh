#!/bin/bash
set -e
echo "Applying: IOL catalog dropdown for Implant Verification actual-implanted selection"

cat > "app/(main)/ot-intraop/workspace.js" << 'PYEOF_5230786021313756357'
'use client';
...
PYEOF_5230786021313756357

cat > "app/(main)/ot-intraop/actions.js" << 'PYEOF_7851068405717606275'
'use server';
