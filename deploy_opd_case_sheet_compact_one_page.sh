...
#
# Compacts the OPD Case Sheet print template so a normal consultation
# (vision/IOP + distance & near refraction + anterior/posterior exam
# + applanation + gonioscopy + diagnosis + prescription) fits on one
# A4 page instead of spilling onto a second sheet.
#
# Verified against Krishan Gopal (VEH-00021)'s real case sheet data:
#   - Before this change: 2 pages
#   - After this change:  1 page
#
# Changes: smaller base font (13px -> 10.5px), tighter table cell
# padding (6px -> 3px), tighter section spacing, smaller headings,
# and a scoped @page print margin (8mm/10mm vs the app-wide
# 14mm/12mm) just for this template. Glasses Prescription and every
# other print template (invoice, receipt, discharge summary, etc.)
# are untouched.
