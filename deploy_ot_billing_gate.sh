#!/bin/bash
set -e
echo "Applying: OT billing gate, Surgery Billing fields in New Invoice, revert discharge-gate"

cat > "app/(main)/billing/actions.js" << 'PYEOF_3324649417410063888'
'use server';
...
PYEOF_3324649417410063888

cat > "app/(main)/billing/new/new-invoice-tab.js" << 'PYEOF_4952789201857256273'
'use client';
...
PYEOF_4952789201857256273

cat > "app/(main)/ot-intraop/actions.js" << 'PYEOF_6223521567316136535'
'use server';
...
PYEOF_6223521567316136535

cat > "app/(main)/ot-intraop/page.js" << 'PYEOF_1071459856402076509'
'use client';
...
PYEOF_1071459856402076509

cat > "app/print-templates/actions.js" << 'PYEOF_7711969046481139604'
'use server';
