#!/bin/bash
set -e
echo "Applying: new OT Schedule module (Scheduled OT + OT History), moved out of Counselling"

mkdir -p "app/(main)/ot-schedule"

cat > "app/(main)/ot-schedule/actions.js" << 'PYEOF_2831420358183623779'
'use server';
...
PYEOF_2831420358183623779

cat > "app/(main)/ot-schedule/page.js" << 'PYEOF_8266513632691920832'
'use client';
...
PYEOF_8266513632691920832

cat > "app/(main)/counselling/page.js" << 'PYEOF_7990087889313954830'
'use client';
...
PYEOF_7990087889313954830

cat > "app/(main)/counselling/actions.js" << 'PYEOF_4917388895726734140'
'use server';
...
PYEOF_4917388895726734140

cat > "app/components/AppShell.js" << 'PYEOF_3380329180239336792'
'use client';
