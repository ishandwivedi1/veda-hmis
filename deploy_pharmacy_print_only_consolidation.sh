#!/bin/bash
set -e
echo "Applying: itemized medicines on invoice, consolidated only on print/PDF"

cat > "app/(main)/billing/new/new-invoice-tab.js" << 'PYEOF_4204510733215960779'
'use client';
...
PYEOF_4204510733215960779

cat > "app/print-templates/actions.js" << 'PYEOF_5579666988682324109'
'use server';
