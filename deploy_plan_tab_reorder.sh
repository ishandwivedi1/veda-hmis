#!/usr/bin/env bash
# Reorders the Diagnosis & Plan tab sections:
#   1. Investigations  2. Diagnosis  3. Treatment (Prescription /
#   Optical Advice / Procedures / Surgery)  4. Patient Management
#   (Patient Instructions / Counselling / Referral / Follow-up)
# Same fields, same logic -- pure reorder + regrouping.
#
# Usage: run from the ROOT of your veda-hmis repo checkout:
#   bash deploy_plan_tab_reorder.sh
set -euo pipefail
...
echo "  git commit -m \"Reorder Diagnosis & Plan: Investigations, Diagnosis, Treatment, Patient Management\""
echo "  git push"
echo "==================================================================="
