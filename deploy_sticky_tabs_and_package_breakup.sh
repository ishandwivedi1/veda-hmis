#!/bin/bash
set -e
echo "Applying: fix sticky billing tabs + package breakup in invoice generation and print"

cat > "app/(main)/billing/billing-tabs.js" << 'PYEOF_4348918875163889678'
'use client';
...
PYEOF_4348918875163889678

cat > "app/(main)/billing/actions.js" << 'PYEOF_828246452378747061'
'use server';
...
PYEOF_828246452378747061

cat > "app/(main)/billing/new/new-invoice-tab.js" << 'PYEOF_2374029547051758855'
'use client';
...
PYEOF_2374029547051758855

cat > "app/print-templates/actions.js" << 'PYEOF_8689642659937420830'
'use server';
