mkdir -p "app/components" "app/(main)/payments/receipt" "app/(main)/payments/refund"

# Old Refund/Modification tab is fully replaced -- removed from Payments entirely.
rm -rf "app/(main)/payments/cancel"
...
cat > "app/(main)/payments/refund/page.js" << 'EOF'
...
echo "Edit Payment (clerical) added to Receipt; Refund rebuilt and moved to Patient Ledger section."