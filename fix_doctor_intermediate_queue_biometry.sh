...
echo 'Applying: fix doctor intermediate queue missing Awaiting Biometry...'
...
echo '  git add "app/(main)/doctor-dashboard/actions.js" "app/(main)/doctor-dashboard/page.js"'
echo '  git commit -m "Fix doctor intermediate queue missing patients sent for Biometry"'
echo '  git push'
