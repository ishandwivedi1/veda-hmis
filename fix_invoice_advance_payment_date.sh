...
echo 'Applying fix: invoice printout showing advance ADJUSTMENT date instead of the actual advance COLLECTION date'

mkdir -p "app/print-templates"
cat > "app/print-templates/actions.js" << 'VEDAEOF'
'use server';
...
VEDAEOF
echo "Wrote app/print-templates/actions.js"
...
git commit -m "Invoice print: show the TRUE original advance collection date (FIFO-resolved) instead of the advance_adjustment transaction date"
git push
