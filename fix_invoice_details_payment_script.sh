mkdir -p "app/(main)/billing" "app/(main)/billing/details"
...
echo "Invoice Details Record Payment replaced with redirect to Collect Payment; broken record_payment removed."