...
echo 'Applying: fix Mark for Surgery not showing persisted state...'
...
echo '  git add "app/(main)/consultation/actions.js" "app/(main)/consultation/[id]/consultation-form.js"'
echo '  git commit -m "Fix Mark for Surgery not showing persisted state after save"'
echo '  git push'
