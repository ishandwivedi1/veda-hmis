...
echo 'Applying: fix package billing -- trigger from Counselling, remove auto-pay bug, route through Collect Payment...'

mkdir -p 'app/(main)/billing/new' 'app/(main)/billing/package' 'app/(main)/front-office-dashboard'
...
cat > 'app/(main)/billing/package/package-billing-tab.js' << 'PKG_BILLING_TAB_EOF'
'use client';
...
cat > 'app/(main)/front-office-dashboard/package-billing-widget.js' << 'PKG_WIDGET_EOF'
'use client';
...
cat > 'app/(main)/front-office-dashboard/page.js' << 'FO_DASHBOARD_PAGE_EOF'
...
echo '  git add "app/(main)/billing/actions.js" "app/(main)/billing/new/new-invoice-tab.js" "app/(main)/billing/package/package-billing-tab.js" "app/(main)/front-office-dashboard/package-billing-widget.js" "app/(main)/front-office-dashboard/page.js"'
echo '  git commit -m "Fix package billing: trigger from Counselling via Front Office widget, route through Collect Payment instead of auto-marking paid"'
echo '  git push'
