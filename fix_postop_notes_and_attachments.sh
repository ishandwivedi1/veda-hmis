...
echo 'Applying: clearer notes display, separate Edit Notes action, optional file upload per follow-up...'
...
echo '  git commit -m "Post Op: always-visible notes with dedicated edit action, optional file upload per follow-up"'
echo '  git push'
