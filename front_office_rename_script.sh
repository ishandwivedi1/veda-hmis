# Remove the old folder -- it's been renamed to front-office-dashboard
rm -rf 'app/(main)/reception-dashboard'

mkdir -p 'app/(main)/front-office-dashboard' app/components 'app/(main)/patients/new' 'app/(main)/appointments/new' 'app/(main)/visits/new' 'app/(main)/appointments'
...
echo "Renamed to Front Office Dashboard, all completion actions now redirect there."
