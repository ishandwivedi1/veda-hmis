...
echo "== Veda HMIS: IOL Approval deviation warning + View Biometry Report, Fitness moved after IOL order/date, Package selection matches Counselling, Biometry lock mode, duplicate-order guard, referral print simplification ==" 
...
cat > "app/(main)/iol-approval/page.js" << '__VEDA_FILE_6_END__'
'use client';
...
cat > "app/(main)/medical-fitness/page.js" << '__VEDA_FILE_7_END__'
'use client';
...
cat > "app/(main)/patient-timeline/page.js" << '__VEDA_FILE_8_END__'
'use client';
...
cat > "app/(main)/surgical-journey/[id]/workspace.js" << '__VEDA_FILE_9_END__'
'use client';
...
cat > "app/(main)/surgical-journey/actions.js" << '__VEDA_FILE_10_END__'
'use server';
...
cat > "app/consultation/[id]/consultation-form.js" << '__VEDA_FILE_11_END__'
'use client';
...
cat > "app/consultation/[id]/follow-up-panel.js" << '__VEDA_FILE_12_END__'
'use client';
...
cat > "app/print-templates/actions.js" << '__VEDA_FILE_13_END__'
'use server';
...
git commit -m "IOL Approval: deviation warning vs biometry recommendations, View Biometry Report button; Surgical Journey: Medical Fitness now after IOL order & surgery date; Package selection matches Counselling; Biometry lock mode with doctor-only edit; duplicate-order guard; Biometry queue routing fix; simplified external investigation referral print"
