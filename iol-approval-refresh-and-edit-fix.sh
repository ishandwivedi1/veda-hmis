...
echo "== Veda HMIS: IOL Approval live refresh + Edit/revise approved cases, deviation warning, View Biometry Report, Fitness after IOL order/date, Package selection, Biometry lock mode, duplicate-order guard, referral print simplification ==" 

mkdir -p "app/(main)/biometry" "app/(main)/biometry/[id]" "app/(main)/consultation" "app/(main)/investigation" "app/(main)/investigation/history" "app/(main)/iol-approval" "app/(main)/medical-fitness" "app/(main)/patient-timeline" "app/(main)/surgical-journey" "app/(main)/surgical-journey/[id]" "app/consultation/[id]" "app/print-templates"
...
cat > "app/(main)/patient-timeline/page.js" << '__VEDA_FILE_9_END__'
'use client';
...
cat > "app/(main)/surgical-journey/[id]/workspace.js" << '__VEDA_FILE_10_END__'
'use client';
...
cat > "app/(main)/surgical-journey/actions.js" << '__VEDA_FILE_11_END__'
'use server';
...
cat > "app/consultation/[id]/consultation-form.js" << '__VEDA_FILE_12_END__'
'use client';
...
cat > "app/consultation/[id]/follow-up-panel.js" << '__VEDA_FILE_13_END__'
'use client';
...
cat > "app/print-templates/actions.js" << '__VEDA_FILE_14_END__'
'use server';
...
git commit -m "IOL Approval: live 15s refresh (was stale until manual reload), Edit button to revise a same-day approval with pre-filled values, deviation warning vs biometry recommendations, View Biometry Report button; Surgical Journey: Medical Fitness after IOL order & surgery date, package selection matches Counselling; Biometry lock mode with doctor-only edit; duplicate-order guard; Biometry queue routing fix; simplified external investigation referral print"
