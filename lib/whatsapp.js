...
export async function sendWhatsAppTemplate({
  ...
  try {
    ...
    await logWhatsAppMessage({ mobile, templateName, meta, success: true, response: data });
 ...
 */
export async function sendRegistrationWhatsApp({ name, patientId, mobile, meta = {} }) {
 ...
 * should not break the calling flow (e.g. registration).
 */
