...
echo "== Move Consultation out of the main app shell =="
echo "   It only ever opens as its own window now, so it no longer needs"
echo "   the sidebar/topbar -- just the colored patient header + tabs,"
echo "   frozen at the top of its own focused window."

echo "-- Removing old location app/(main)/consultation/[id] --"
rm -rf "app/(main)/consultation/[id]"

echo "-- Writing app/consultation/[id]/follow-up-panel.js --"
mkdir -p "$(dirname "app/consultation/[id]/follow-up-panel.js")"
cat > "app/consultation/[id]/follow-up-panel.js" << 'JSEOF_48541095'
'use client';
...
echo "-- Writing app/consultation/[id]/consultation-form.js --"
mkdir -p "$(dirname "app/consultation/[id]/consultation-form.js")"
cat > "app/consultation/[id]/consultation-form.js" << 'JSEOF_35547851'
'use client';
...
echo "-- Writing app/consultation/[id]/examination-tab.js --"
mkdir -p "$(dirname "app/consultation/[id]/examination-tab.js")"
cat > "app/consultation/[id]/examination-tab.js" << 'JSEOF_81228654'
'use client';
...
echo "-- Writing app/consultation/[id]/history-tab.js --"
mkdir -p "$(dirname "app/consultation/[id]/history-tab.js")"
cat > "app/consultation/[id]/history-tab.js" << 'JSEOF_99899474'
'use client';
...
echo "-- Writing app/consultation/[id]/optometry-tab.js --"
mkdir -p "$(dirname "app/consultation/[id]/optometry-tab.js")"
cat > "app/consultation/[id]/optometry-tab.js" << 'JSEOF_74149690'
'use client';
...
echo "-- Writing app/consultation/[id]/page.js --"
mkdir -p "$(dirname "app/consultation/[id]/page.js")"
cat > "app/consultation/[id]/page.js" << 'JSEOF_12052560'
...
echo "-- Writing supporting files (bundled in case not already applied) --"
echo "-- Writing app/(main)/consultation/actions.js --"
mkdir -p "$(dirname "app/(main)/consultation/actions.js")"
cat > "app/(main)/consultation/actions.js" << 'JSEOF_29363430'
'use server';
...
cat > "app/(main)/doctor-dashboard/page.js" << 'JSEOF_26681140'
'use client';
...
cat > "app/(main)/ot-postop/workspace.js" << 'JSEOF_42437412'
'use client';
...
cat > "app/(main)/master-data/clinical/page.js" << 'JSEOF_45837473'
'use client';
...
cat > "app/(main)/master-data/financial/page.js" << 'JSEOF_64767694'
'use client';
...
cat > "app/(main)/billing/actions.js" << 'JSEOF_95515918'
'use server';
...
cat > "app/(main)/billing/new/new-invoice-tab.js" << 'JSEOF_20395456'
'use client';
...
cat > "app/(main)/billing/new/page.js" << 'JSEOF_11169561'
...
cat > "app/(main)/front-office-dashboard/page.js" << 'JSEOF_46157785'
...
cat > "app/(main)/front-office-dashboard/procedures-billing-widget.js" << 'JSEOF_97125479'
'use client';
