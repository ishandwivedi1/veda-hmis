...
echo "Applying: optometry footer buttons, doctor-override visibility for optometrist, doctor confirm popup"
...
cat > "app/consultation/[id]/optometry-tab.js" << 'VEDA_EOF_MARKER'
'use client';
