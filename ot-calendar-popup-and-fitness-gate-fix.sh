...
echo "== Veda HMIS: compact professional OT calendar (standalone popup, no sidebar chrome), fixed Medical Fitness blocking OT booking, IOL Approval live refresh + Edit, Fitness after IOL order, Package selection, Biometry lock mode, duplicate-order guard, referral print simplification ==" 

mkdir -p "app/(main)/biometry" "app/(main)/biometry/[id]" "app/(main)/consultation" "app/(main)/counselling" "app/(main)/investigation" "app/(main)/investigation/history" "app/(main)/iol-approval" "app/(main)/medical-fitness" "app/(main)/ot-schedule" "app/(main)/patient-timeline" "app/(main)/surgical-journey" "app/(main)/surgical-journey/[id]" "app/consultation/[id]" "app/ot-calendar-picker" "app/print-templates" "lib"
...
cat > "app/(main)/investigation/actions.js" << '__VEDA_FILE_4_END__'
'use server';
...
cat > "app/(main)/investigation/history/page.js" << '__VEDA_FILE_5_END__'
'use client';
...
cat > "app/(main)/investigation/page.js" << '__VEDA_FILE_6_END__'
'use client';
...
cat > "app/(main)/iol-approval/actions.js" << '__VEDA_FILE_7_END__'
'use server';
...
cat > "app/(main)/iol-approval/page.js" << '__VEDA_FILE_8_END__'
'use client';
...
cat > "app/(main)/medical-fitness/page.js" << '__VEDA_FILE_9_END__'
'use client';
...
cat > "app/(main)/ot-schedule/actions.js" << '__VEDA_FILE_10_END__'
'use server';
...
cat > "app/(main)/ot-schedule/ot-calendar.js" << '__VEDA_FILE_11_END__'
'use client';
...
cat > "app/(main)/ot-schedule/page.js" << '__VEDA_FILE_12_END__'
'use client';
...
cat > "app/(main)/patient-timeline/page.js" << '__VEDA_FILE_13_END__'
'use client';
...
cat > "app/(main)/surgical-journey/[id]/workspace.js" << '__VEDA_FILE_14_END__'
'use client';
...
cat > "app/(main)/surgical-journey/actions.js" << '__VEDA_FILE_15_END__'
'use server';
...
cat > "app/consultation/[id]/consultation-form.js" << '__VEDA_FILE_16_END__'
'use client';
...
cat > "app/consultation/[id]/follow-up-panel.js" << '__VEDA_FILE_17_END__'
'use client';
...
cat > "app/ot-calendar-picker/page.js" << '__VEDA_FILE_18_END__'
'use client';
...
cat > "app/print-templates/actions.js" << '__VEDA_FILE_19_END__'
'use server';
...
cat > "lib/popup.js" << '__VEDA_FILE_20_END__'
...
git commit -m "OT Calendar: standalone popup route (no sidebar chrome, compact 340px grid) instead of embedding full OT Schedule layout; fixed markReadyForScheduling still blocking booking on Medical Fitness (now happens after booking); IOL Approval live 15s refresh + Edit; Medical Fitness after IOL order & surgery date; Package selection matches Counselling; Biometry lock mode with doctor-only edit; duplicate-order guard; Biometry queue routing fix; simplified external investigation referral print"
