...
echo "== Veda HMIS: Package selection (Surgical Journey, matches Counselling), Biometry lock-mode + doctor-only edit, direct View Report link, duplicate-order guard, Biometry queue fix, referral print simplification ==" 

mkdir -p "app/(main)/biometry" "app/(main)/biometry/[id]" "app/(main)/consultation" "app/(main)/investigation" "app/(main)/investigation/history" "app/(main)/medical-fitness" "app/(main)/patient-timeline" "app/(main)/surgical-journey" "app/(main)/surgical-journey/[id]" "app/consultation/[id]" "app/print-templates"
...
cat > "app/(main)/medical-fitness/page.js" << '__VEDA_FILE_6_END__'
'use client';
...
cat > "app/(main)/patient-timeline/page.js" << '__VEDA_FILE_7_END__'
'use client';
...
cat > "app/(main)/surgical-journey/[id]/workspace.js" << '__VEDA_FILE_8_END__'
'use client';
...
cat > "app/(main)/surgical-journey/actions.js" << '__VEDA_FILE_9_END__'
'use server';
...
cat > "app/consultation/[id]/consultation-form.js" << '__VEDA_FILE_10_END__'
'use client';
...
cat > "app/consultation/[id]/follow-up-panel.js" << '__VEDA_FILE_11_END__'
'use client';
...
cat > "app/print-templates/actions.js" << '__VEDA_FILE_12_END__'
'use server';
...
git add -A
git reset -- apply-and-deploy.sh 2>/dev/null || true
git commit -m "Surgical Journey package selection now matches Counselling (origin badge, includes preview, Financial Masters > Surgery messaging); Biometry lock mode with doctor-only edit; direct View Report link; duplicate-order guard; Biometry queue routing fix; simplified external investigation referral print"
