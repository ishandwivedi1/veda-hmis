...
echo "== Editable Print Templates system -- starting with Invoice/Bill =="
echo "   New Print Templates admin page (sidebar -> Administration) lets"
echo "   staff edit the HTML behind each printed document, with live"
echo "   preview against sample data. Invoice/Bill is built to match the"
echo "   reference PDF; more (receipts, reports, consent forms, discharge"
echo "   summaries) get added the same way, one at a time."

echo "-- Installing handlebars (template engine) --"
npm install handlebars --no-audit --no-fund

echo "-- Writing app/print-templates/actions.js --"
mkdir -p "$(dirname "app/print-templates/actions.js")"
cat > "app/print-templates/actions.js" << 'JSEOF_12260713'
'use server';
...
echo "-- Writing app/invoice-print/[invoiceId]/page.js --"
mkdir -p "$(dirname "app/invoice-print/[invoiceId]/page.js")"
cat > "app/invoice-print/[invoiceId]/page.js" << 'JSEOF_88758320'
...
echo "-- Writing app/(main)/print-templates/page.js --"
mkdir -p "$(dirname "app/(main)/print-templates/page.js")"
cat > "app/(main)/print-templates/page.js" << 'JSEOF_39579497'
'use client';
...
cat > "app/components/AppShell.js" << 'JSEOF_92385887'
'use client';
...
echo "== Done. DB migration (print_templates table) already applied live. =="
