    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 20 }}>
        ...
        <div className="card">
          ...
          <table className="tbl">
            <thead><tr><th>Time</th><th>Patient</th><th>Type</th><th>Doctor</th><th>Status</th><th>Billing</th><th></th></tr></thead>
            <tbody>
              {(todaysVisits || []).map((v) => {
...
echo "Reception Dashboard updated -- Today Visits widget with billing."
