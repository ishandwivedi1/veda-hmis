...
echo 'Applying: big-visibility Procedure/Eye/Package/Surgeon blocks, remove Procedure Documentation...'
...
echo '  git add "app/(main)/ot-intraop/actions.js" "app/(main)/ot-intraop/workspace.js"'
echo '  git commit -m "OT Intraop: big-visibility case summary blocks, remove Procedure Documentation section"'
echo '  git push'
