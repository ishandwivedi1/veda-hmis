mkdir -p "app/(main)/payments/receipt"
...
const TYPE_LABEL = { invoice_payment: 'Payment', advance: 'Advance', advance_adjustment: 'Adjustment', credit_note: 'Credit Note', refund: 'Refund' };
...
echo "Refunds now show up in Receipt Register, tagged distinctly with their own REF number."