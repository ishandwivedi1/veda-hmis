...
echo "== Remodeling Consultation workspace: new context sidebar =="
echo "   Previous Visit Summary (button+modal), Patient Timeline, and"
echo "    Previous Investigations moved into a new left sidebar -- the"
echo "    existing right sidebar (Encounter Status etc) is untouched."

echo "-- Writing app/(main)/consultation/[id]/follow-up-panel.js --"
mkdir -p "$(dirname "app/(main)/consultation/[id]/follow-up-panel.js")"
cat > "app/(main)/consultation/[id]/follow-up-panel.js" << 'JSEOF_6114717'
'use client';
...
cat > "app/(main)/consultation/[id]/consultation-form.js" << 'JSEOF_36199752'
'use client';
