...
echo "== Veda HMIS: split Operation Theatre into Patient Check-In + Intraoperative Management modules ==" 
...
cat > "app/(main)/ot-intraop/page.js" << '__VEDA_FILE_12_END__'
'use client';
...
cat > "app/(main)/ot-intraop/workspace.js" << '__VEDA_FILE_13_END__'
'use client';
...
cat > "app/(main)/ot-schedule/actions.js" << '__VEDA_FILE_14_END__'
'use server';
...
cat > "app/(main)/ot-schedule/ot-calendar.js" << '__VEDA_FILE_15_END__'
'use client';
...
cat > "app/(main)/ot-schedule/page.js" << '__VEDA_FILE_16_END__'
'use client';
...
cat > "app/(main)/patient-checkin/page.js" << '__VEDA_FILE_17_END__'
'use client';
...
export default function PatientCheckinPage() {
  ...
  return (
    <div>
      ...
      {activeTab === 'dashboard' && <DashboardTab cases={cases} loading={loadingCases} onOpen={openCase} onRefresh={refreshCases} returnTo="patient-checkin" />}
...
cat > "app/(main)/patient-timeline/page.js" << '__VEDA_FILE_18_END__'
'use client';
...
cat > "app/(main)/payments/advance/advance-tab.js" << '__VEDA_FILE_19_END__'
'use client';
...
cat > "app/(main)/surgical-journey/[id]/workspace.js" << '__VEDA_FILE_20_END__'
'use client';
...
cat > "app/(main)/surgical-journey/actions.js" << '__VEDA_FILE_21_END__'
'use server';
...
cat > "app/components/AppShell.js" << '__VEDA_FILE_22_END__'
'use client';
...
cat > "app/consultation/[id]/consultation-form.js" << '__VEDA_FILE_23_END__'
'use client';
...
cat > "app/consultation/[id]/follow-up-panel.js" << '__VEDA_FILE_24_END__'
'use client';
...
cat > "app/medical-fitness-print/[referralId]/page.js" << '__VEDA_FILE_25_END__'
...
cat > "app/ot-calendar-picker/page.js" << '__VEDA_FILE_26_END__'
'use client';
...
cat > "app/print-templates/actions.js" << '__VEDA_FILE_27_END__'
'use server';
...
cat > "lib/popup.js" << '__VEDA_FILE_28_END__'
...
git commit -m "Split Operation Theatre into two separate modules: Patient Check-In (new, /patient-checkin) and Intraoperative Management (renamed, still /ot-intraop) -- same underlying data/checklist, Workspace component now takes a restrictTab prop so each module only shows its own tab and locks/redirects appropriately; Surgical Journey Day of Surgery deep-links updated to point to the right module per stage; sidebar nav and advance-payment return-to links updated to match"
git push origin main

echo "== Done. Vercel will redeploy production and training automatically. =="
echo "== NOTE: DB-side fixes already applied directly to both Supabase projects and need no action here. =="
